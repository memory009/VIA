...
from verification.polar_verifier_lightweight import verify_safety
...
def verify_single_trajectory_worker(args):
    ...
    agent = TD3_Lightweight(
        ...
        device=device,
        load_model=True,
        model_name="TD3_lightweight_best",  # ← 加载best模型
...
def main():
    ...
    # ===== 6. 保存结果 =====
    output_path = Path(__file__).parent.parent / "assets" / "reachability_results_parallel_lightweight.json"
